clean_data <- function(data) {
  ...
  cleaned <- cleaned |> 
    ...
    mutate(
      treatment = case_when(
        rowSums(cleaned[, c("DASP14", "DLH14", "DMH14", "DSCH", "DIVH")] == "U") > 0 ~ NA_character_, 
        DASP14 == "Y" & (rowSums(cleaned[, c("DLH14", "DMH14", "DSCH", "DIVH")] == "Y") > 0) ~ "Aspirin & Heparin",
        DASP14 == "Y" ~ "Aspirin",
        rowSums(cleaned[, c("DLH14", "DMH14", "DSCH", "DIVH")] == "Y") > 0 ~ "Heparin",
